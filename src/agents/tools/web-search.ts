        ...
        : params.provider === "kimi"
          ...
          : params.provider === "gemini"
            ...
            : params.provider === "searxng"
              ? `${params.provider}:${params.query}:${params.count}:${params.searxngUrl ?? DEFAULT_SEARXNG_URL}:${params.searxngCategories || DEFAULT_SEARXNG_CATEGORIES}:${params.searxngEngines?.join(",") || ""}:${params.searxngLanguage || DEFAULT_SEARXNG_LANGUAGE}:${params.searxngSafeSearch ?? 0}`
