...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.healthMonitor.timing.staleEventThresholdMs": "Stale Event Threshold (ms)",
  "gateway.healthMonitor.timing.monitorStartupGraceMs": "Monitor Startup Grace (ms)",
  "gateway.healthMonitor.timing.channelConnectGraceMs": "Channel Connect Grace (ms)",
